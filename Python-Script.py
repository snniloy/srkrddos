...
if str(platform.system()) == 'Linux':
    os.system('figlet RS DDoS Attack')
else:
    os.system('pyfiglet RS  DDoS Attack')

print(Back.GREEN + Fore.GREEN +'[+] DDoS tool by' + Fore.RED + ' RS                               ') 
print(Back.GREEN + Fore.BLACK + '[+] DDoS Tool BETA VERSION 0.4                                             ')
print(Back.BLACK +Fore.GREEN + '[+] RS-DDoS                          ')
print(Fore.YELLOW + '[+] We are legend                            ')
print(Fore.GREEN + '[+] Starting 1024 Threads as Default change below as Required           ')
print(Fore.BLUE + 'edited by: ' + Fore.GREEN + ' (RS)')
